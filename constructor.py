...
print("    cd finsecure-bank && php -S 0.0.0.0:8080")
print("\nAccede en tu navegador: http://localhost:8080")
...
print("   http://localhost:8080/transferir.php?origen=alice&destino=eve&monto=30000000")
